...
abstract contract GovernancePowerDelegationERC20 is ERC20, IGovernancePowerDelegationToken {
     ...
     * In this initial implementation with no COOK minting, simply returns the current supply
     * A snapshots mapping will need to be added in case a mint function is added to the COOK token in the future
     **/
     ...
     * the COOK token and StakeToken already include a mapping for the snapshots, so we require contracts
