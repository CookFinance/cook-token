...
contract CookToken {
    ...
    function mint(address dst, uint rawAmount) external {
        require(msg.sender == minter, "Cook::mint: only the minter can mint");
        require(block.timestamp >= mintingAllowedAfter, "Cook::mint: minting not allowed yet");
        require(dst != address(0), "Cook::mint: cannot transfer to the zero address");
